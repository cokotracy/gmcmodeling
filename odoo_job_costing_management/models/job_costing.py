...
class JobCosting(models.Model):
    ...
    subcontractor_total = fields.Float(string='Total SubContractor', compute='_compute_subcontractor_total',
                                       store=True, )
    equipment_total = fields.Float(string='Total Equipment', compute='_compute_equipment_total', store=True, )
    other_total = fields.Float(string='Total Other', compute='_compute_other_total', store=True, )
    ...
    jobcost_total = fields.Float(string='Breakdown Cost', compute='_compute_jobcost_total', store=True, )
